...
--
-- Applied via: supabase/migrations/20250222000000_account_account_members_profile.sql
...
-- Allow inserts for trigger (SECURITY DEFINER) and for future "add member" (service role or policy)
